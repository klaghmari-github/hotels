...
def _worker_shard(
    ...
    from scrape_accor.scrape_codes import scrape_code_list
...
def _load_codes(
    *,
    ...
    from scrape_accor.hotels import code_for_url
    from scrape_accor.scrape_codes import _load_codes_from_xlsx
...
def _filter_existing(codes: list[str]) -> list[str]:
    from scrape_accor.scrape_codes import _existing_codes
...
def run_parallel(
    *,
    ...
    if merge_all:
        from scrape_accor.orchestrator import merge_all_hotels
