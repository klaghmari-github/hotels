"""Configuration du corner store (concept, mix, contraintes)."""
...
@dataclass
class CategoryMix:
    """Répartition F&B / N-F&B et parts par catégorie ou gamme."""
...
class StoreConfiguration:
    """Paramètres retail saisis ou optimisés par le directeur."""
    ...
    @classmethod
    def from_dict(cls, data: dict | None) -> StoreConfiguration:
        data = data or {}
        ...
        return cls(
            ...
            locked_fields=list(data.get("locked_fields") or []),
        )