...
from eval_common import COMMON_CSS, open_pipeline
from main import run_restitution
...
def _mix_feature_name(family: str, label: str) -> str:
    from main import normalized_mix_name
...
def predict_dense(body: dict) -> dict:
    ...
    import joblib
    import torch
    from ml_dense import DenseRegressor
