...
from accor.hotel_solutions import SOLUTION_FLAG_COLS, load_pilot_solution_codes
from accor.model_data import MAIN_TARGET
from accor.model_eval import _metrics_1d
...
def _load_ml_bundle(tier: str = "final") -> tuple[Any, list[str], str, str] | None:
    ...
    try:
        if tier == "final":
            from accor.model_final import get_final_top_model, list_final_models, load_final_model
            ...
            from accor.model_train import get_top_model, list_design_models, load_design_model
...
def evaluate_pilots_sim_vs_ia(
    *,
    ...
    try:
        from accor.model_train import _load_model_frame
