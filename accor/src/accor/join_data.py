...
from accor.geo_proximity import ProximityFromGeo, as_coord as prox_as_coord
from accor.geo_weather import WeatherFromGeo, as_coord as weather_as_coord
from accor.schemas import DATA_DIR, get_schema
...
def _fill_weather_gaps(
    ...
    *,
    ...
    from accor.geo_weather import meteo_column_names
