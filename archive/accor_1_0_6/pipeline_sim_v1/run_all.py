...
def main() -> int:
    ...
    from archive.accor_1_0_6.pipeline_sim_v1.constants import EVAL_CODES, EXCLUDED_HOTELS
    from archive.accor_1_0_6.pipeline_sim_v1.run_pipeline import export_pipeline_excel, run_loo_pipeline
    from archive.accor_1_0_6.pipeline_sim_v1.sim_v1_old import run as run_old
