...
from archive.accor_1_0_6.pipeline_sim_v1.constants import DATA_DIR, EXCEL_NEW, PROJECT_ROOT
from archive.accor_1_0_6.pipeline_sim_v1.prepare_sources import prepare_all
...
def open_sim_v1_pipeline(*, rebuild_db: bool = False):
    ...
    from archive.accor_1_0_6.main import ConnectionPipeline
