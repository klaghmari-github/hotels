...
def _scrape_accor_row(code: str) -> dict[str, Any]:
    ...
    """
    from archive.accor_1_0_6.pipelines.src.accor.scrape_accor.hotels import code_for_url, fetch_hotel
...
def fetch_and_upsert_hotel(code: str, *, persist: bool = True) -> dict[str, Any]:
    ...
    try:
        from archive.accor_1_0_6.pipelines.src.accor.store import reload_dataset
