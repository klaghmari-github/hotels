...
from archive.accor_1_0_6.pipelines.src.accor.model_data import (
    MAIN_TARGET,
    VENTES_SUR_ACHATS,
    marge_from_ventes,
    ventes_from_marge,
...
from archive.accor_1_0_6.pipelines.src.accor.user.rules.coeffs import CLIENT_NEED_LABELS, LIBERTY_NFB_NEEDS
from archive.accor_1_0_6.pipelines.src.accor.user.rules.costs import CostRules
from archive.accor_1_0_6.pipelines.src.accor.user.rules.pilot_table import get_pilot
...
def director_simulate(body: dict[str, Any]) -> dict[str, Any]:
    ...
    from archive.accor_1_0_6.pipelines.src.accor.user.rules.assortment import (
        FB_KEYS,
        NFB_KEYS,
        needs_from_shares,
