...
from archive.accor_1_0_6.pipelines.src.accor.user.models import EnrichedFeatures, HotelIdentity, SimulationRequest
...
class FeatureEnricher:
    ...
    def enrich(
        ...
        *,
        ...
        if do_proximity:
            try:
                from archive.accor_1_0_6.pipelines.src.accor.geo_proximity import ProximityFromGeo
        ...
        if do_weather:
            try:
                import pandas as pd
                from archive.accor_1_0_6.pipelines.src.accor.geo_weather import WeatherFromGeo
    ...
    def _holidays_summary(lat: float, lon: float) -> dict[str, Any]:
        ...
        from archive.accor_1_0_6.pipelines.src.accor.geo_holidays import (
            _days_in_month,
            _days_in_ranges,
