    ...
    def build(
        ...
        *,
        ...
        if not hotels.empty and "hotel_code" in hotels.columns:
            ...
            if match.empty:
                # variantes H / pad
                from archive.accor_1_0_6.pipelines.src.accor.user.services.hotel_fetch import code_variants
        ...
        if not row and fetch_if_missing and code:
            try:
                from archive.accor_1_0_6.pipelines.src.accor.user.services.hotel_fetch import (
        ...
        from archive.accor_1_0_6.pipelines.src.accor.brand_category import brand_to_category_map, mean_for_category
        ...
        if brand_cat is None and any(
            ...
            from archive.accor_1_0_6.pipelines.src.accor.brand_category import category_from_dummies
        ...
        from archive.accor_1_0_6.pipelines.src.accor.user.hotel_form import (
