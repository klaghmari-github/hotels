...
from archive.accor_1_0_6.pipelines.src.accor.data_io import DATA_DIR, MODELS_DIR, PROJECT_ROOT
...
def _load_model_frame() -> tuple[pd.DataFrame, dict[str, Any]]:
    ...
    if not meta:
        # recompute roles
        from archive.accor_1_0_6.pipelines.src.accor.model_data import classify_columns, build_model_dataframe
