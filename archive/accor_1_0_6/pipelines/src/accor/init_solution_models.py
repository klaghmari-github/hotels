...
def status_snapshot() -> dict[str, Any]:
    ...
    from archive.accor_1_0_6.pipelines.src.accor.model_final import list_final_models
    from archive.accor_1_0_6.pipelines.src.accor.model_train import list_design_models
...
def ensure_solution_models(
    *,
    ...
    from archive.accor_1_0_6.pipelines.src.accor.model_final import list_final_models, train_final_model
