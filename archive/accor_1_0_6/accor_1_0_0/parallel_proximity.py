...
from archive.accor_1_0_6.accor_1_0_0.parallel_common import chunk_list, load_france_hotels as _load_fr
...
def _worker_shard(
    ...
    from archive.accor_1_0_6.accor_1_0_0.geo_proximity import ProximityFromGeo, ProximityFromGeo as _  # noqa: F401
    from archive.accor_1_0_6.accor_1_0_0.geo_proximity import empty_proximity_features, id_and_feature_columns
...
def merge_shards(*, out_path: Path | None = None) -> dict[str, Any]:
    from archive.accor_1_0_6.accor_1_0_0.geo_proximity import save_proximity_frame
    ...
    if skip_existing and OUT_XLSX.exists():
        try:
            ...
            if not done.empty and "hotel_code" in done.columns:
                ...
                from archive.accor_1_0_6.accor_1_0_0.geo_proximity import ProximityFromGeo
