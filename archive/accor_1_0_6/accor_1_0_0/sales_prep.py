...
from archive.accor_1_0_6.accor_1_0_0.data_io import DATA_DIR, read_excel
...
def attach_holiday_sales(
    ...
    from archive.accor_1_0_6.accor_1_0_0.geo_holidays import holidays_day_sets, load_holidays_frame
...
class SalesPrepPipeline:
    ...
    def join_holidays(self) -> "SalesPrepPipeline":
        from archive.accor_1_0_6.accor_1_0_0.geo_holidays import load_holidays_frame
