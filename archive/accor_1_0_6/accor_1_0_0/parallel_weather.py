...
def _worker_shard(
    ...
    from archive.accor_1_0_6.accor_1_0_0.geo_common import filter_frame_to_pairs
    from archive.accor_1_0_6.accor_1_0_0.geo_weather import WeatherFromGeo, meteo_column_names
