...
from archive.accor_1_0_5.src.accor.rod_admin import (
    JOURS_MOIS,
    _load_hotels,
    _load_sales,
    _round,
...
def build_concept_reference(
    ...
    *,
    ...
    try:
        from archive.accor_1_0_5.src.accor.simulator_data import load_solution_baselines
...
def simulate_excel_dual(
    ...
    *,
    ...
    try:
        from archive.accor_1_0_5.src.accor.simulator_data import (
