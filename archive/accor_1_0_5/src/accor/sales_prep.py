...
from archive.accor_1_0_5.src.accor.data_io import DATA_DIR, PROJECT_ROOT, read_excel
...
def attach_holiday_sales(
    ...
    from archive.accor_1_0_5.src.accor.geo_holidays import holidays_day_sets, load_holidays_frame
...
class SalesPrepPipeline:
    ...
    def join_holidays(self) -> "SalesPrepPipeline":
        from archive.accor_1_0_5.src.accor.geo_holidays import load_holidays_frame
