...
from archive.accor_1_0_5.src.accor.data_io import MODELS_DIR
from archive.accor_1_0_5.src.accor.model_data import MAIN_TARGET, rebuild_model_data
...
def get_final_config_payload(solution: str | None = None) -> dict[str, Any]:
    ...
    from archive.accor_1_0_5.src.accor.model_train import get_config_payload
...
def list_final_models(solution: str | None = None) -> list[dict[str, Any]]:
    ...
    if sol:
        ...
        from archive.accor_1_0_5.src.accor.hotel_solutions import SOLUTIONS
...
def train_final_model(
    *,
    ...
    from archive.accor_1_0_5.src.accor.hotel_solutions import SOLUTION_FLAG_COLS, filter_frame_by_solution
    from archive.accor_1_0_5.src.accor.model_train import MIN_EVAL_ROWS, MIN_TRAIN_ROWS, _apply_solution_filter
...
def start_final_build(
    *,
    ...
    from archive.accor_1_0_5.src.accor.model_train import GridSearchPlanner
