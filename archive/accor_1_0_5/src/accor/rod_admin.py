...
from archive.accor_1_0_5.src.accor.brand_category import (
...
from archive.accor_1_0_5.src.accor.user.rules.coeffs import RULE3_BASELINE_FB, RULE3_BASELINE_NF
...
def build_category_reference(
    ...
    *,
    ...
    from archive.accor_1_0_5.src.accor.user.services.hotel_context import (
...
def all_needs_open() -> dict[str, bool]:
    ...
    from archive.accor_1_0_5.src.accor.user.rules.coeffs import RULE3_FB_COEFFS, RULE3_NFB_COEFFS
...
def rod_ui_meta() -> dict[str, Any]:
    ...
    from archive.accor_1_0_5.src.accor.user.rules.coeffs import (
        CLIENT_NEED_LABELS,
        RULE3_FB_COEFFS,
        RULE3_NFB_COEFFS,
    )
    ...
    * règles ROD → CA, coûts, marge pour les 3 concepts + reco.
    ...
    for c in CONCEPTS:
        ...
        try:
            ...
            from archive.accor_1_0_5.src.accor.user.models import ConceptSimulation
...
def evaluate_pilots_year(year: int | None = None) -> dict[str, Any]:
    ...
    """
    from archive.accor_1_0_5.src.accor.hotel_solutions import load_pilot_solution_codes
