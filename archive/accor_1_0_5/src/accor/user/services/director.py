...
from archive.accor_1_0_5.src.accor.model_data import (
    MAIN_TARGET,
    VENTES_SUR_ACHATS,
    marge_from_ventes,
    ventes_from_marge,
...
from archive.accor_1_0_5.src.accor.user.rules.coeffs import CLIENT_NEED_LABELS, LIBERTY_NFB_NEEDS
...
def director_simulate(body: dict[str, Any]) -> dict[str, Any]:
    ...
    """
    from archive.accor_1_0_5.src.accor.user.hotel_form import (
        params_to_feature_overrides,
        params_to_services,
        resolve_params,
    )
    from archive.accor_1_0_5.src.accor.user.models import DEFAULT_CLIENT_NEEDS
    from archive.accor_1_0_5.src.accor.user.rules.assortment import (
        FB_KEYS,
        NFB_KEYS,
        needs_from_shares,
