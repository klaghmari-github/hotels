...
from archive.accor_1_0_5.src.accor.user.models import SimulationRequest
from archive.accor_1_0_5.src.accor.user.reference import RodReference
from archive.accor_1_0_5.src.accor.user.services.catalog import AdminCatalog
from archive.accor_1_0_5.src.accor.user.services.enrich import FeatureEnricher
from archive.accor_1_0_5.src.accor.user.services.geocode import Geocoder
from archive.accor_1_0_5.src.accor.user.services.hotel_context import HotelContextBuilder
from archive.accor_1_0_5.src.accor.user.services.orchestrator import SimulationOrchestrator
...
def meta():
    ...
    try:
        from archive.accor_1_0_5.src.accor.user.hotel_form import compute_global_defaults, schema_for_api
...
def api_rod_simulate():
    ...
    try:
        from archive.accor_1_0_5.src.accor.user.services.director import director_simulate
...
def concept_pilote_brand_averages(brand: str):
    ...
    """
    from archive.accor_1_0_5.src.accor.concept_pilote import brand_step1_averages
...
def api_rule1():
    ...
    """
    from archive.accor_1_0_5.src.accor.concept_pilote import rule1_ca_by_concept
