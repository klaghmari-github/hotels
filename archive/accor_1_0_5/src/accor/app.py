...
from archive.accor_1_0_5.src.accor.schemas import list_datasets
from archive.accor_1_0_5.src.accor.store import (
    add_row,
    delete_rows,
    page_payload,
    rebuild_joined_data,
...
from archive.accor_1_0_5.src.accor.cache_bust import register_cache_bust
from archive.accor_1_0_5.src.accor.data_io import PROJECT_ROOT, STATIC_DIR, TEMPLATES_DIR
...
def api_rebuild_join():
    ...
    try:
        ...
        try:
            from archive.accor_1_0_5.src.accor.store import _cache
...
def api_rebuild_model_data():
    ...
    """
    try:
        from archive.accor_1_0_5.src.accor.model_data import rebuild_model_data
        from archive.accor_1_0_5.src.accor.store import _cache
...
def api_rebuild_sales():
    ...
    """
    try:
        from archive.accor_1_0_5.src.accor.sales_prep import ensure_raw_sales_from_archive, rebuild_hotel_sales_data
        from archive.accor_1_0_5.src.accor.store import _cache
...
def api_export_sales_model():
    ...
    """
    try:
        from archive.accor_1_0_5.src.accor.sales_model_export import export_all
...
def api_rebuild_weather():
    ...
    """
    try:
        from archive.accor_1_0_5.src.accor.geo_weather import rebuild_hotel_weather_data
        from archive.accor_1_0_5.src.accor.store import _cache
...
def api_rebuild_proximity():
    ...
    """
    try:
        from archive.accor_1_0_5.src.accor.geo_proximity import rebuild_hotel_proximity_data
        from archive.accor_1_0_5.src.accor.store import _cache
...
def api_rebuild_holidays():
    ...
    """
    try:
        from archive.accor_1_0_5.src.accor.geo_holidays import rebuild_hotel_holidays_data
        from archive.accor_1_0_5.src.accor.store import _cache
...
def api_rebuild_concept_pilote():
    ...
    * mix F_B / N_F_B = produits distincts (sales_raw prioritaire)
    """
    try:
        from archive.accor_1_0_5.src.accor.concept_pilote import rebuild_concept_pilote
        from archive.accor_1_0_5.src.accor.store import _cache
...
def api_rebuild_simulateur_data():
    ...
    """
    try:
        from archive.accor_1_0_5.src.accor.simulator_data import rebuild_simulateur_data
        from archive.accor_1_0_5.src.accor.store import _cache
...
def api_model_config():
    ...
    """
    try:
        from archive.accor_1_0_5.src.accor.hotel_solutions import SOLUTIONS, normalize_solution
        from archive.accor_1_0_5.src.accor.model_train import get_config_payload, list_design_models
        ...
        try:
            from archive.accor_1_0_5.src.accor.model_train import _load_model_frame, _apply_solution_filter
...
def api_model_list():
    ...
    try:
        from archive.accor_1_0_5.src.accor.hotel_solutions import normalize_solution
        from archive.accor_1_0_5.src.accor.model_train import get_last_trained, get_top_model, list_design_models
...
def api_model_eval_meta():
    ...
    try:
        from archive.accor_1_0_5.src.accor.hotel_solutions import normalize_solution
        from archive.accor_1_0_5.src.accor.model_eval import eval_meta
...
def api_model_eval():
    ...
    """
    try:
        from archive.accor_1_0_5.src.accor.model_eval import evaluate_model
...
def api_rod_eval_compare():
    ...
    """
    try:
        from archive.accor_1_0_5.src.accor.rod_compare_eval import evaluate_pilots_sim_vs_ia
...
def api_model_build():
    ...
    try:
        ...
        from archive.accor_1_0_5.src.accor.model_train import train_model
...
def api_model_build_progress():
    ...
    try:
        from archive.accor_1_0_5.src.accor.model_train import get_build_progress
...
def api_model_build_count():
    ...
    body = request.get_json(force=True, silent=True) or {}
    try:
        from archive.accor_1_0_5.src.accor.model_train import count_grid_jobs
...
def api_model_deploy():
    ...
    body = request.get_json(force=True, silent=True) or {}
    try:
        from archive.accor_1_0_5.src.accor.model_train import deploy_model
...
def api_model_detail(model_id: str):
    ...
    try:
        from archive.accor_1_0_5.src.accor.model_train import DESIGN_DIR
...
def api_model_explore(model_id: str):
    ...
    try:
        from archive.accor_1_0_5.src.accor.model_explore import explore_overview
...
def api_model_tree(model_id: str):
    ...
    try:
        from archive.accor_1_0_5.src.accor.model_explore import get_tree
...
def api_model_trees_table(model_id: str):
    ...
    try:
        from archive.accor_1_0_5.src.accor.model_explore import trees_table
...
def api_model_importance(model_id: str):
    ...
    try:
        from archive.accor_1_0_5.src.accor.model_explore import feature_importance_payload
...
def api_final_config():
    ...
    try:
        from archive.accor_1_0_5.src.accor.hotel_solutions import SOLUTIONS, normalize_solution
        from archive.accor_1_0_5.src.accor.model_final import get_final_config_payload
...
def api_final_build():
    ...
    body = request.get_json(force=True, silent=True) or {}
    try:
        from archive.accor_1_0_5.src.accor.model_final import start_final_build
        from archive.accor_1_0_5.src.accor.model_train import count_grid_jobs
...
def api_final_build_progress():
    try:
        from archive.accor_1_0_5.src.accor.model_final import get_final_build_progress
...
def api_final_deploy():
    body = request.get_json(force=True, silent=True) or {}
    try:
        from archive.accor_1_0_5.src.accor.model_final import deploy_final_model
...
def api_rod_pilots():
    ...
    """
    try:
        from archive.accor_1_0_5.src.accor.rod_admin import list_pilot_hotels
...
def api_rod_meta():
    ...
    try:
        from archive.accor_1_0_5.src.accor.rod_admin import rod_ui_meta
...
def api_rod_sim_params():
    ...
    """
    try:
        from archive.accor_1_0_5.src.accor.user.rules.sim_params import build_sim_params
...
def api_rod_hotel_trace(hotel_code: str):
    ...
    """
    try:
        from archive.accor_1_0_5.src.accor.rod_admin import simulate_hotel_trace
...
def api_rod_eval():
    ...
    """
    try:
        from archive.accor_1_0_5.src.accor.rod_admin import evaluate_pilots_year
...
def api_rod_excel_meta():
    ...
    try:
        from archive.accor_1_0_5.src.accor.rod_excel_sim import excel_ui_meta
...
def api_rod_excel_pilots():
    ...
    try:
        from archive.accor_1_0_5.src.accor.rod_excel_sim import list_excel_pilots
...
def main(argv: list[str] | None = None) -> None:
    ...
    from archive.accor_1_0_5.src.accor.serve_utils import (
        default_host,
        default_port,
        print_listen_banner,
        run_flask_app,
    ...
    try:
        from archive.accor_1_0_5.src.accor.init_solution_models import spawn_ensure_if_missing
