...
from archive.accor_1_0_5.accor_1_0_0.user.models import SimulationRequest
from archive.accor_1_0_5.accor_1_0_0.user.reference import RodReference
from archive.accor_1_0_5.accor_1_0_0.user.rules.coeffs import CLIENT_NEED_LABELS, RULE3_FB_COEFFS, RULE3_NFB_COEFFS
from archive.accor_1_0_5.accor_1_0_0.user.services.catalog import AdminCatalog
from archive.accor_1_0_5.accor_1_0_0.user.services.enrich import FeatureEnricher
from archive.accor_1_0_5.accor_1_0_0.user.services.geocode import Geocoder
from archive.accor_1_0_5.accor_1_0_0.user.services.hotel_context import HotelContextBuilder
from archive.accor_1_0_5.accor_1_0_0.user.services.orchestrator import SimulationOrchestrator
...
def concept_pilote_brand_averages(brand: str):
    ...
    """
    from archive.accor_1_0_5.accor_1_0_0.concept_pilote import brand_step1_averages
...
def api_rule1():
    ...
    """
    from archive.accor_1_0_5.accor_1_0_0.concept_pilote import rule1_ca_by_concept
