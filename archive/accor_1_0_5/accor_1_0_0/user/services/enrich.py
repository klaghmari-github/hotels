...
from archive.accor_1_0_5.accor_1_0_0.user.models import EnrichedFeatures, HotelIdentity, SimulationRequest
...
class FeatureEnricher:
    ...
    def enrich(
        ...
        *,
        ...
        if do_weather:
            try:
                import pandas as pd
                from archive.accor_1_0_5.accor_1_0_0.geo_weather import WeatherFromGeo
    ...
    def _holidays_summary(lat: float, lon: float) -> dict[str, Any]:
        ...
        from archive.accor_1_0_5.accor_1_0_0.geo_holidays import (
            _days_in_month,
            _days_in_ranges,
