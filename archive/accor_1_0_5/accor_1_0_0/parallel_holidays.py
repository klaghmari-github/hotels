...
def _worker_shard(
    ...
    from archive.accor_1_0_5.accor_1_0_0.geo_holidays import compute_holidays_rows
...
def merge_shards(*, out_path: Path | None = None) -> dict[str, Any]:
    from archive.accor_1_0_5.accor_1_0_0.geo_holidays import save_holidays_frame
...
def run_parallel(*, workers: int = 12, skip_existing: bool = True) -> dict[str, Any]:
    ...
    from archive.accor_1_0_5.accor_1_0_0.geo_holidays import _hotel_meta_lookup, load_holidays_frame
