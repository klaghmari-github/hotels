...
from archive.accor_1_0_5.accor_1_0_0.schemas import list_datasets
from archive.accor_1_0_5.accor_1_0_0.store import (
    add_row,
    delete_rows,
    page_payload,
    rebuild_joined_data,
...
def api_rebuild_join():
    ...
    try:
        ...
        try:
            from archive.accor_1_0_5.accor_1_0_0.store import _cache
...
def api_rebuild_model_data():
    ...
    try:
        from archive.accor_1_0_5.accor_1_0_0.model_data import rebuild_model_data
        from archive.accor_1_0_5.accor_1_0_0.store import _cache
...
def api_rebuild_sales():
    ...
    """
    try:
        from archive.accor_1_0_5.accor_1_0_0.sales_prep import ensure_raw_sales_from_archive, rebuild_hotel_sales_data
        from archive.accor_1_0_5.accor_1_0_0.store import _cache
...
def api_rebuild_weather():
    ...
    """
    try:
        from archive.accor_1_0_5.accor_1_0_0.geo_weather import rebuild_hotel_weather_data
        from archive.accor_1_0_5.accor_1_0_0.store import _cache
...
def api_rebuild_proximity():
    ...
    """
    try:
        from archive.accor_1_0_5.accor_1_0_0.geo_proximity import rebuild_hotel_proximity_data
        from archive.accor_1_0_5.accor_1_0_0.store import _cache
...
def api_rebuild_holidays():
    ...
    """
    try:
        from archive.accor_1_0_5.accor_1_0_0.geo_holidays import rebuild_hotel_holidays_data
        from archive.accor_1_0_5.accor_1_0_0.store import _cache
...
def api_rebuild_concept_pilote():
    ...
    * mix F_B / N_F_B = produits distincts (sales_raw prioritaire)
    """
    try:
        from archive.accor_1_0_5.accor_1_0_0.concept_pilote import rebuild_concept_pilote
        from archive.accor_1_0_5.accor_1_0_0.store import _cache
...
def api_model_config():
    ...
    try:
        from archive.accor_1_0_5.accor_1_0_0.model_train import get_config_payload
...
def api_model_list():
    ...
    try:
        from archive.accor_1_0_5.accor_1_0_0.model_train import get_last_trained, get_top_model, list_design_models
...
def api_model_build():
    ...
    body = request.get_json(force=True, silent=True) or {}
    try:
        from archive.accor_1_0_5.accor_1_0_0.model_train import (
            build_and_save,
            count_grid_jobs,
            start_build_batch,
        )
...
def api_model_build_progress():
    ...
    try:
        from archive.accor_1_0_5.accor_1_0_0.model_train import get_build_progress
...
def api_model_build_count():
    ...
    body = request.get_json(force=True, silent=True) or {}
    try:
        from archive.accor_1_0_5.accor_1_0_0.model_train import count_grid_jobs
...
def api_model_deploy():
    ...
    body = request.get_json(force=True, silent=True) or {}
    try:
        from archive.accor_1_0_5.accor_1_0_0.model_train import deploy_model
...
def api_model_detail(model_id: str):
    ...
    try:
        from archive.accor_1_0_5.accor_1_0_0.model_train import DESIGN_DIR
...
def api_model_explore(model_id: str):
    ...
    try:
        from archive.accor_1_0_5.accor_1_0_0.model_explore import explore_overview
...
def api_model_tree(model_id: str):
    ...
    try:
        from archive.accor_1_0_5.accor_1_0_0.model_explore import get_tree
...
def api_model_trees_table(model_id: str):
    ...
    try:
        from archive.accor_1_0_5.accor_1_0_0.model_explore import trees_table
...
def api_model_importance(model_id: str):
    ...
    try:
        from archive.accor_1_0_5.accor_1_0_0.model_explore import feature_importance_payload
