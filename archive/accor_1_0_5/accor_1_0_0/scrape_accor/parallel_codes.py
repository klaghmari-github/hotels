...
def _worker_shard(
    ...
    from archive.accor_1_0_5.accor_1_0_0.scrape_accor.scrape_codes import scrape_code_list
...
def _load_codes(
    *,
    ...
    from archive.accor_1_0_5.accor_1_0_0.scrape_accor.hotels import code_for_url
    from archive.accor_1_0_5.accor_1_0_0.scrape_accor.scrape_codes import _load_codes_from_xlsx
...
def _filter_existing(codes: list[str]) -> list[str]:
    from archive.accor_1_0_5.accor_1_0_0.scrape_accor.scrape_codes import _existing_codes
...
def _merge_shards(shard_paths: list[Path], out_path: Path) -> int:
    ...
    from archive.accor_1_0_5.accor_1_0_0.scrape_accor.hotels import code_for_url, write_hotels_xlsx
...
def run_parallel(
    *,
    ...
    if merge_all:
        from archive.accor_1_0_5.accor_1_0_0.scrape_accor.orchestrator import merge_all_hotels
