...
from archive.accor_1_0_5.accor_1_0_0.geo_proximity import ProximityFromGeo, as_coord as prox_as_coord
from archive.accor_1_0_5.accor_1_0_0.geo_weather import WeatherFromGeo, as_coord as weather_as_coord
from archive.accor_1_0_5.accor_1_0_0.schemas import DATA_DIR, get_schema
...
def fill_numeric_nulls(frame: pd.DataFrame) -> pd.DataFrame:
    ...
    **Déprécié pour all_data** — ne plus combler les trous sources.
    ...
    moment model_data.
    """
    from archive.accor_1_0_5.accor_1_0_0.impute_model import impute_for_model
