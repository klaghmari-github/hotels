...
def _worker_shard(
    ...
    from geo_proximity import ProximityFromGeo, ProximityFromGeo as _  # noqa: F401
    from geo_proximity import empty_proximity_features, id_and_feature_columns
...
def merge_shards(*, out_path: Path | None = None) -> dict[str, Any]:
    from geo_proximity import save_proximity_frame
    ...
    if skip_existing and OUT_XLSX.exists():
        try:
            ...
            if not done.empty and "hotel_code" in done.columns:
                ...
                from geo_proximity import ProximityFromGeo
