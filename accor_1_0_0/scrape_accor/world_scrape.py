...
from scrape_accor.countries_config import COUNTRIES, WORLD_SLUGS
from scrape_accor.destination_country import (
    HOTELS_DIR,
    fetch_catalog,
    find_missing,
...
def run_scrape_missing(
    *,
    ...
    from scrape_accor.parallel_codes import run_parallel
